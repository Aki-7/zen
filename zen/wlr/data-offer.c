...
static uint32_t
zn_wlr_data_offer_choose_action(struct zn_wlr_data_offer *self)
{
...
void
zn_wlr_data_offer_update_action(struct zn_wlr_data_offer *self)
{
  uint32_t action = zn_wlr_data_offer_choose_action(self);
  ...
  wl_data_offer_send_action(self->resource, action);
}

static void
zn_wlr_data_offer_handle_destroy(struct wl_resource *resource)
{
  struct zn_wlr_data_offer *self = wl_resource_get_user_data(resource);

  zn_wlr_data_offer_destroy(self);
}
 ...
 */
static void
zn_wlr_data_offer_protocol_accept(struct wl_client *client,
 ...
 */
static void
zn_wlr_data_offer_protocol_receive(struct wl_client *client,
 ...
 */
static void
zn_wlr_data_offer_protocol_destroy(
...
static void
zn_wlr_data_offer_source_dnd_finish(struct zn_wlr_data_offer *self)
{
  if (self->source->actions < 0) {
    return;
  }
 ...
 */
static void
zn_wlr_data_offer_protocol_finish(
    struct wl_client *client, struct wl_resource *resource)
{
  UNUSED(client);
  ...
  enum wl_data_device_manager_dnd_action action =
      self->source->current_dnd_action;
  ...
  zn_wlr_data_offer_source_dnd_finish(self);
}
 ...
 */
static void
zn_wlr_data_offer_protocol_set_actions(struct wl_client *client,
    ...
    uint32_t preferred_action)
{
  ...
  zn_wlr_data_offer_update_action(self);
}

static const struct wl_data_offer_interface implementation = {
    .accept = zn_wlr_data_offer_protocol_accept,
    .receive = zn_wlr_data_offer_protocol_receive,
    .destroy = zn_wlr_data_offer_protocol_destroy,
    .finish = zn_wlr_data_offer_protocol_finish,
    .set_actions = zn_wlr_data_offer_protocol_set_actions,
};

static void
zn_wlr_data_offer_handle_source_destroy(
    struct wl_listener *listener, void *data)
{
  UNUSED(data);
  struct zn_wlr_data_offer *self =
...
zn_wlr_data_offer_create(
    struct wl_client *client, uint32_t id, struct zn_data_source *source)
{
  struct zn_wlr_data_offer *self = zalloc(sizeof *self);
  if (self == NULL) {
  ...
  self->resource = wl_resource_create(client, &wl_data_offer_interface, 3, id);
  ...
  wl_resource_set_implementation(
      self->resource, &implementation, self, zn_wlr_data_offer_handle_destroy);
...
void
zn_wlr_data_offer_destroy(struct zn_wlr_data_offer *self)
{
